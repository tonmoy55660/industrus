<?php
$title = "Industrus | Sewing Master Dasboard";
include 'includes/admin-header.php';
include 'check-sewing.php';
include_once("../dbCon.php");
$conn = connect();
$sql = "SELECT * FROM order_tasks WHERE department_id = 3";
...
$sql = "SELECT SUM(CASE WHEN Status = 2 THEN 1 ELSE 0 END) AS `Finished`, SUM(CASE WHEN Status = 1 THEN 1 ELSE 0 END) AS `In-progress` FROM order_tasks WHERE department_id = 3";
$stmt = $conn->prepare($sql);
$stmt->execute();
$result = $stmt->get_result();
